...
public class TestCheckQuestionsAnswers extends BaseUITest {

    private final String questionNumber;
    private final String answerNumber;
    private final String expected;

    public TestCheckQuestionsAnswers(String questionNumber, String answerNumber, String expected) {
        super(driver);
    ...
    public void checkAccordionButtonTextMatch() {
        MainPage mainPage = new MainPage(driver)
                .openUrl()
                .scrollToQuestion()
                .clickQuestionButton(questionNumber);
        mainPage.getQuestionText(answerNumber);
        String actual = mainPage.getQuestionText(answerNumber);
        Assert.assertEquals ("Ожидаемый текст не совпадает с фактическим", expected, actual);
    }
